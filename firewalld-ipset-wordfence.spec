%global ipset_name wordfence

Name:           firewalld-ipset-%{ipset_name}
Version:        20251219
Release:        1%{?dist}
Summary:        Wordfence security scanner IP addresses
License:        BSD
Requires:       firewalld
BuildArch:      noarch
URL:            https://www.wordfence.com/help/advanced/
Source0:        %{ipset_name}.xml
BuildRequires:  python3


%description
Wordfence security scanner IP addresses
